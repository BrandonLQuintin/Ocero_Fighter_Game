...
var main = function (vertexShaderText, fragmentShaderText) {
	...
	var width = window.innerWidth; // sets screen to 4:3 aspect ratio
    var height = window.innerHeight; // this was generated by copilot
	var maxWidth = height * (4 / 3);
    var maxHeight = width * (3 / 4);
    if (width > maxWidth) {
        width = maxWidth;
    } else {
        height = maxHeight;
